...
WHERE M.idSucursal = 2 AND P.idTipoProducto = 4";  
      ...
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE ACCESORIOS DE "ALICEL 2"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_Accesorios_Alicel2.xls");  
           echo $output;  
      }    
 ?>  