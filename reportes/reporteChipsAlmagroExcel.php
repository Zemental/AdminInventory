...
WHERE M.idSucursal = 5 AND P.idTipoProducto = 2";  
      $result = mysqli_query($connect, $sql);  
      if(mysqli_num_rows($result) > 0)  
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE CHIPS DE "ALMAGRO"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_chips_Almagro.xls");  
           echo $output;  
      }    
 ?>  