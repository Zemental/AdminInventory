...
WHERE M.idSucursal = 6 AND P.idTipoProducto = 1";  
      ...
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE CELULARES DE "AS MOVILES"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_celulares_Alicel2.xls");  
           echo $output;  
      }    
 ?>  