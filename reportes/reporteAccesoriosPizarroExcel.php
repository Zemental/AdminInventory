...
WHERE M.idSucursal = 4 AND P.idTipoProducto = 4";  
      ...
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE ACCESORIOS DE "PIZARRO"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_Accesorios_Pizarro.xls");  
           echo $output;  
      }    
 ?>  