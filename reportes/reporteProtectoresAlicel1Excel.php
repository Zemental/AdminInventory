...
WHERE M.idSucursal = 1 AND P.idTipoProducto = 3";  
      $result = mysqli_query($connect, $sql);  
      if(mysqli_num_rows($result) > 0)  
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE PROTECTORES DE "ALICEL 1"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_Protectores_Alicel1.xls");  
           echo $output;  
      }    
 ?>  