...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" pagegroup="new" style="font-size: 12pt">
    <page_header> 
        ...
        <br><br><br>
        <div align="center">   
		    <strong style="font-size: 14pt">SALDOS DE CELULARES DE "AS MOVILES"</strong>
		</div><br><br>
    </page_header>
	...
	<br><br><br><br><br>
      <?php
            ...
            $query = "SELECT DM.idProducto, C.imei, C.serie, C.modelo, DM.cantidad, DM.cantidadvendida FROM detallemovimiento DM 
...
WHERE M.idSucursal = 6 AND P.idTipoProducto = 1";
...
">CODIGO</th>
			                <th style="width: 14%; text-align: center; height: 16px; text-align: center;border:0; background-color: #4DBAEF">IMEI</th>
			                <th style="width: 14%; text-align: center; height: 16px; text-align: center;border:0; background-color: #4DBAEF">SERIE</th>
			                <th style="width: 28%; text-align: center; height: 16px; text-align: center;border:0; background-color: #4DBAEF">MODELO</th>
            ...
            echo '<tr>
                    ...
                    <td style="width: 14%; height: 14px; text-align: center ;border-bottom:0; border-right:0; border-left:0">'.$campo['imei'].'</td>
                    <td style="width: 14%; height: 14px; text-align: center ;border-bottom:0; border-right:0; border-left:0">'.$campo['serie'].'</td>
					<td style="width: 28%; height: 14px; text-align: center ;border-bottom:0; border-right:0; border-left:0">'.$campo['modelo'].'</td>
...
<?php
	...
	$pdf->Output('Lista_de_Saldos_celulares_Alice2.pdf')
