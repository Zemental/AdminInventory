...
WHERE M.idSucursal = 5 AND P.idTipoProducto = 3";  
      $result = mysqli_query($connect, $sql);  
      if(mysqli_num_rows($result) > 0)  
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE PROTECTORES DE "ALMAGRO"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_Protectores_Almagro.xls");  
           echo $output;  
      }    
 ?>  