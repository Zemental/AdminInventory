...
WHERE M.idSucursal = 4 AND P.idTipoProducto = 2";  
      ...
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE CHIPS DE "PIZARRO"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_chips_Pizarro.xls");  
           echo $output;  
      }    
 ?>  