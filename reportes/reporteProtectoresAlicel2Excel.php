...
WHERE M.idSucursal = 2 AND P.idTipoProducto = 3";  
      $result = mysqli_query($connect, $sql);  
      if(mysqli_num_rows($result) > 0)  
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE PROTECTORES DE "ALICEL 2"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_Protectores_Alicel2.xls");  
           echo $output;  
      }    
 ?>  