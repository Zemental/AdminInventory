...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" pagegroup="new" style="font-size: 12pt">
    <page_header> 
        ...
        <br><br><br>
        <div align="center">   
		    <strong style="font-size: 14pt">SALDOS DE ACCESORIOS DE "AS MOVILES"</strong>
		</div><br><br>
    </page_header>
	...
	<br><br><br><br><br>
      <?php
            ...
            $query = "SELECT DM.idProducto, TA.nombre, C.codigo, C.descripcion, DM.cantidad, DM.cantidadvendida FROM detallemovimiento DM 
...
WHERE M.idSucursal = 6 AND P.idTipoProducto = 4";
...
">COD PRODUCTO</th>
			                ...
			                <th style="width: 14%; text-align: center; height: 16px; text-align: center;border:0; background-color: #4DBAEF">CODIGO</th>
...
<?php
	...
	$pdf->Output('Lista_de_Saldos_Accesorios_ASMOVILES.pdf')
