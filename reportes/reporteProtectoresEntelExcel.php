...
WHERE M.idSucursal = 3 AND P.idTipoProducto = 3";  
      ...
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE PROTECTORES DE "ENTEL"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_Protectores_Entel.xls");  
           echo $output;  
      }    
 ?>  