...
WHERE M.idSucursal = sucursal AND P.idTipoProducto = 4";  
      ...
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE CHIPS DE "AS MOVILES"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_chips_Moviles.xls");  
           echo $output;  
      }    
 ?>  