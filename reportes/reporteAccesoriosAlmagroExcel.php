...
WHERE M.idSucursal = 5 AND P.idTipoProducto = 4";  
      ...
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE ACCESORIOS DE "ALMAGRO"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_Accesorios_Almagro.xls");  
           echo $output;  
      }    
 ?>  