...
WHERE M.idSucursal = 6 AND P.idTipoProducto = 4";  
      ...
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE ACCESORIOS DE "AS MOVILES"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_Accesorios_ASMoviles.xls");  
           echo $output;  
      }    
 ?>  