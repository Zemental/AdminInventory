...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" pagegroup="new" style="font-size: 12pt">
    <page_header> 
        ...
        <br><br><br>
        <div align="center">   
		    <strong style="font-size: 14pt">SALDOS DE ACCESORIOS DE "ALICEL 2"</strong>
		</div><br><br>
    </page_header>
...
WHERE M.idSucursal = 2 AND P.idTipoProducto = 4";
...
<?php
	...
	$pdf->Output('Lista_de_Saldos_Accesorios_Alicel2.pdf')
