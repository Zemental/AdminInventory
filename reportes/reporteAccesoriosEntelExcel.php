...
WHERE M.idSucursal = 3 AND P.idTipoProducto = 4";  
      ...
      {  
           $output .= '  
                <strong style="text-align:center; color:red;">SALDOS DE ACCESORIOS DE "ENTEL"</strong><br><br>
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Saldos_Accesorios_Entel.xls");  
           echo $output;  
      }    
 ?>  