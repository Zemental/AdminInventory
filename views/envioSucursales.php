                ...
                <div class="row">
                    ...
                    <div class="form-group">    
                        ...
                        <div class="col-md-1">                                     
                            <label for="">.</label>
                            <div class="input-group">
                                <button disabled type="button" class="btn btn-success btn-md ace-icon fa fa-plus" id="addRow">
                                </button>                                           
                            </div>                                                                        
                        </div>                      
                    </div> 
                    ...
                    <div class="form-group">                                                              
                        ...
                        <div class="col-md-2">                                     
                            ...
                            <div class="input-group">
                                <input class="form-control col-md-12 " type="text" name="param_cantidadProtec" id="param_cantidadProtec" value="1" />                                           
                            </div>                                                                        
                        </div>
                        <div class="col-md-1">                                     
                            <label for="">.</label>
                    ...
                    <div class="form-group">                                                              
                        ...
                        <div class="col-md-2">                                     
                            <label for="">CANTIDAD</label>
                            <div class="input-group">
                                <input class="form-control col-md-12 " type="text" name="param_cantidadAcce" id="param_cantidadAcce" value="1" />                                           
                            </div>                                                                        
                        </div>
                        <div class="col-md-1">                                     
                            <label for="">.</label>
