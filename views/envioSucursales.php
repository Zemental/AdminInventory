...
<div id="main-wrapper">
    ...
    <div id="content-wrapper">
        <div class="page-header">
            <div class="row">
                <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-mobile page-header-icon"></i>&nbsp;&nbsp;Envio a Sucursales</h1>
            </div>
        </div>
            ...
            <div class="panel-heading">
                ...
                <div class="panel-body">
                    <div class="table-primary">
                        <table class="table table-striped table-bordered" id="tablaDetalleEnvios">
                            <thead>
                                <tr>
                                    <th style="text-align: center; font-size: 11px; height: 10px; width: 10%;">CANTIDAD</th>
                                    <th style="text-align: center; font-size: 11px; height: 10px; width: 50%;">DESCRIPCION</th>                       
                                    <th style="text-align: center; font-size: 11px; height: 10px; width: 15%;">OPERACIONES</th>
                                </tr>
                            </thead>
                            <tbody id="cuerpoDetalleEnvios">
                ...
                <div class="row">                    
                    <div class="form-group">    
                        <!-- / CELULARES -->                                                                              
                        <div class="col-sm-7 col-md-offset-8">                                     
                            <label class="col-sm-4 control-label" style="color:red">TOTAL DE PRODUCTOS:</label>
                                <div class="col-sm-2">
                ...
                <button type="button" class="btn btn-primary btn-md ace-icon fa fa-plus col-md-offset-5" id="registrarEnvio"> REGISTRAR
                </button>
...
<script type="text/javascript">
    init.push(function () {        
        ...
        $('#tablaDetalleEnvios_wrapper .table-caption').text('Detalle de Envio');
        mostrarSucursal();
        agregarDetalleEnvio();
    });
