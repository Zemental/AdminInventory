                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">                                                                 
                            <div class="input-group">
                                <button type="button" class="btn btn-success btn-md ace-icon fa fa-search" id="buscarVentas">
                                </button>                                           
                            </div>                                                                        
                        </div>  
                        <div class="">                                                                 
                            <div class="input-group">
                                <button type="button" class="btn btn-primary btn-md ace-icon fa fa-refresh" id="todasVentas">
                                </button>                                           
                            </div>                                                                        
                        </div>
                    </div><br>  
                    <button class="btn btn-md btn-labeled btn-danger col-md-offset-8" id="reporteVentas"><span class="btn-label icon fa fa-file-text"></span>Exportar PDF</button>
                    <button class="btn btn-md btn-labeled btn-success" id="reporteVentasExcel"><span class="btn-label icon fa fa-file-text"></span>Exportar EXCEL</button>                              
                </span>
            </div>
