...
<div id="main-wrapper">
    ...
    <div id="content-wrapper">
        <div class="page-header">
            <div class="row">
                <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-mobile page-header-icon"></i>&nbsp;&nbsp;Almacén de Productos (ENTEL)</h1>
            </div>
        </div>

        <script>
            init.push(function () {
                $('#tablaEntel').dataTable();
                $('#tablaEntel_wrapper .table-caption').text('Listado General de Productos');
                $('#tablaEntel_wrapper .dataTables_filter input').attr('placeholder', 'Buscar...');
                mostrarCelulares();
            });
        </script>
        ...
        <div class="panel">           
            <div class="panel-body">
                <div class="table-primary">
                    <table class="table table-striped table-bordered" id="tablaEntel">
                        <thead>
                            <tr>
...
<script src="../assets/javascripts/Entel.js"></script>
