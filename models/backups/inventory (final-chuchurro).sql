...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-06-2016 a las 00:32:53
...
INNER JOIN detallemovimiento DM ON DM.idProducto = P.idProducto WHERE P.idSucursal = sucursal AND DM.stock > 0;
    ...
    IF opcion = 'opc_mostrar_ventas' THEN
        SELECT V.numVenta,V.tipoDocumento,S.nombre, CONCAT(R.nombres,' ',R.apellidos), V.fechaVenta, V.cantidadTotal, V.ventaID FROM venta V 
